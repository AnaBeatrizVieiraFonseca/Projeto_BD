-- ============================================================
-- consultas_professor.sql
-- Arquivo separado com as consultas obrigatorias do professor
-- ============================================================

USE competicao_esportiva;

-- a) Quantos e quais campeonatos de voleibol, basquete e rugby estao em andamento atualmente? ATUALIZAR PARA 2026
...
-- b) Quais equipes de futebol possuem o maior numero de vitorias em uma unica temporada? AUMENTAR VISUALIZAÇÃO DE EQUIPES
...
-- c) Maiores artilheiros ou pontuadores nas ultimas 10 temporadas por modalidade. POUCO REGISTRO DE BASQUETE
...
-- d) Classificacao do futebol masculino sub-11, sub-13, sub-15 e sub-17 na temporada passada. FICOU TOP
...
-- e) Partidas do voleibol feminino adulto com maior publico nas ultimas 5 temporadas. LIMITAR RESULTADOS
...
-- f) Media de pontos por partida de cada equipe de basquete masculino em todas as categorias na ultima temporada. FICOU TOP
...
-- g) Arbitros federados com mais jogos no futsal adulto masculino e feminino na temporada atual. AUMENTAR NÚMERO DE ÁRBITROS
...
-- h) Melhor ataque e melhor defesa no Campeonato de Futebol Amador da Cidade na temporada passada. FICOU TOP
...
-- i) Atletas masculinos com mais penalidades nas ultimas 5 temporadas. CORRIGIR NOMES DE ATLETAS
...
-- j) Estadios ou arenas com mais partidas em cada modalidade e categoria na temporada atual. FICOU TOP
